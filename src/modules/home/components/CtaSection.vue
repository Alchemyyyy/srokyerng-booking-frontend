...
<template>
  <section
    class="w-full bg-(--color-surface-soft) py-16 border-t border-(--color-border)/20"
    ...
    <div class="max-w-7xl mx-auto px-6">
      ...
      >
        ...
        <div class="relative z-10 mt-10 lg:mt-0 lg:ml-8 lg:flex-shrink-0">
          <button
            type="button"
            class="inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-semibold text-blue-900 transition hover:bg-gray-100 shadow-lg cursor-pointer"
